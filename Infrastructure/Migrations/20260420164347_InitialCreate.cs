        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyName = table.Column<string>(name: "Company Name", type: "nvarchar(150)", maxLength: 150, nullable: true),
                    NationalId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PropertyOwnerShipProof = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredArea = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    NationalId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsVerified = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    VerificationStatus = table.Column<int>(type: "int", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GenderAllowed = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HousingUnits", x => x.HousingUnitId);
                    table.ForeignKey(
                        name: "FK_HousingUnits_LandLords_LandLordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_HousingUnits_HousingUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_HousingUnits_HousingUnitId",
                        column: x => x.HousingUnitId,
                        principalTable: "HousingUnits",
                        principalColumn: "HousingUnitId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wishlists_HousingUnits_HousingUnitId",
                        column: x => x.HousingUnitId,
                        principalTable: "HousingUnits",
                        principalColumn: "HousingUnitId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HousingUnits_Area",
                table: "HousingUnits",
                column: "Area");

            migrationBuilder.CreateIndex(
                name: "IX_HousingUnits_City",
                table: "HousingUnits",
                column: "City");

            migrationBuilder.CreateIndex(
                name: "IX_HousingUnits_LandLordId",
                table: "HousingUnits",
                column: "LandLordId");

            migrationBuilder.CreateIndex(
                name: "IX_HousingUnits_Price",
                table: "HousingUnits",
                column: "Price");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_HousingUnitId",
                table: "Wishlists",
                column: "HousingUnitId");
